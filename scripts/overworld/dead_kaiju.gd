...
var modal_scene = preload("res://scenes/game_scene/cutting_minigame/modal_container.tscn")
var cutting_minigame_scene = preload("res://scenes/game_scene/cutting_minigame/cutting_minigame.tscn")
